...
export class RidesMapper {
  static toDomain(dto: RideResponseDTO): RideDomainModel {
    return {
      ...
      archivedAt: normalizeNullableString(dto.archivedAt),
      archivedBy: normalizeNullableString(dto.archivedBy),
      archiveReason: normalizeNullableString(dto.archiveReason),
