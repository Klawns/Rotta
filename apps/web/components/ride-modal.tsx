        ...
        <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
            <DialogContent showCloseButton={false} className="bg-slate-900 border-white/10 p-0 overflow-hidden sm:rounded-[2.5rem] w-[calc(100%-2rem)] max-w-lg sm:max-w-[480px] gap-0 shadow-2xl">
                ...
                <div className="flex flex-col max-h-[90vh] sm:max-h-none relative">
                    ...
                    <div className="px-6 sm:px-10 pt-4 sm:pt-12 pb-6 shrink-0">
                        <div className="flex items-center gap-6">
                            <div className="h-16 w-16 bg-blue-600/10 rounded-[1.5rem] flex items-center justify-center text-blue-400 font-black shadow-inner border border-blue-500/10">
                                <Bike size={32} />
                            </div>
                            <div>
                                <h2 className="text-2xl sm:text-4xl font-black text-white tracking-tighter leading-none">Nova Corrida</h2>
                                <p className="text-slate-500 text-xs sm:text-sm mt-2 uppercase tracking-[0.2em] font-bold opacity-70">Registro Instantâneo</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                            {!clientId && (
                                <div className="space-y-3">
                                    ...
                                    >
                                        <SelectTrigger className="w-full bg-slate-950/50 border border-white/10 rounded-2xl h-auto py-4 px-5 text-white font-bold focus:ring-2 focus:ring-blue-500/50 transition-all shadow-none ring-offset-0">
                                            <SelectValue placeholder="Escolha um cliente..." />
                                        </SelectTrigger>
                                        <SelectContent className="bg-slate-900 border-white/10 text-white rounded-2xl z-[110] shadow-2xl">
                                            {clients.map(c => (
                                                <SelectItem
                                                    key={c.id}
                                                    value={c.id}
                                                    className="focus:bg-blue-600 focus:text-white cursor-pointer py-3.5 rounded-xl mx-1"
                                                >
                                                    {c.name}
                                                </SelectItem>
                                            ))}
                            ...
                            <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                                        {presets.map(preset => (
                                            <button
                                                ...
                                                className={cn(
                                                    "p-3.5 rounded-2xl border flex flex-col items-center justify-center gap-1 transition-all group active:scale-95",
                                                    value === String(preset.value) && notes === preset.location
                                    ...
                                    <div className="grid grid-cols-4 gap-2.5">
                                        {QUICK_VALUES.map(val => (
                                            <button
                                                ...
                                                className={cn(
                                                    "py-3.5 rounded-2xl font-black transition-all border text-sm",
                                                    value === String(val)
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        placeholder="0,00"
                                        required
                                        className="w-full bg-slate-950/50 border border-white/10 rounded-2xl py-5 pl-16 pr-6 text-white text-2xl font-black focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all placeholder:text-slate-800 font-mono shadow-inner"
                                    />
                                </div>
                            </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex bg-slate-950/50 p-1 rounded-2xl border border-white/10">
                                        <button
                                            ...
                                            className={cn(
                                                "flex-1 py-3.5 rounded-[0.85rem] text-[10px] font-black transition-all",
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                <div className="space-y-3">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-950/50 border border-white/10 rounded-2xl py-4 px-5 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all text-[11px] font-bold"
                                    />
                                </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <textarea
                                        ...
                                        rows={1}
                                        className="w-full bg-slate-950/50 border border-white/10 rounded-2xl py-4 px-5 text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all resize-none placeholder:text-slate-700 text-[11px] font-medium min-h-[52px]"
                                    />
                                </div>
                            </div>
                            ...
                            <button
                                ...
                                className="w-full bg-blue-600 hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-black py-5 sm:py-6 rounded-[1.25rem] transition-all shadow-xl shadow-blue-600/30 text-lg flex items-center justify-center gap-3 active:scale-[0.98] group mt-6"
                            >
                                {isSubmitting ? (
